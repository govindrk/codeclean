...
@XmlType(name = "proofCodeCompanyList")
@XmlEnum
public enum ProofCodeCompanyList {
    ...
    ProofCodeCompanyList(String v) {
        value = v;
    }
    public String value() {
        return value;
    }
    public static ProofCodeCompanyList fromValue(String v) {
        for (ProofCodeCompanyList c: ProofCodeCompanyList.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
