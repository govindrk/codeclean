...
@XmlType(name = "frequencyFullList")
@XmlEnum
public enum FrequencyFullList {
    ...
    FrequencyFullList(String v) {
        value = v;
    }
    public String value() {
        return value;
    }
    public static FrequencyFullList fromValue(String v) {
        for (FrequencyFullList c: FrequencyFullList.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
